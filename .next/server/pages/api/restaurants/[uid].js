        ...
        case _declarations_enums_REST__WEBPACK_IMPORTED_MODULE_0__/* .REQUEST_METHODS.GET */ .W.GET:
            {
                try {
                    ...
                    if (!uid) return res.status(401).json({
                        message: _firebase_declarations_enums__WEBPACK_IMPORTED_MODULE_1__/* .MESSAGES.RESTAURANTS_MANDATORY_FIELDS_UID */ .X3.RESTAURANTS_MANDATORY_FIELDS_UID
                    });
                    const restaurantDoc = await _firebase_initServerApp__WEBPACK_IMPORTED_MODULE_2__/* .firestore.collection */ .RZ.collection(_firebase_declarations_enums__WEBPACK_IMPORTED_MODULE_1__/* .COLLECTIONS.RESTAURANTS */ .Ul.RESTAURANTS).doc(uid).get();
                    if (!restaurantDoc.exists) return res.status(404).json({
...
var __webpack_exports__ = __webpack_require__.X(0, [674], () => (__webpack_exec__(7231)));
