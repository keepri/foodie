...
const setSettingsPageApp = (payload: AppSetSettingsPagePayload) => (dispatch: Dispatch<AppAction>) =>
	dispatch({ type: AppActionType.SET_SETTINGS_PAGE, payload });
